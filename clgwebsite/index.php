    ...
    <div class="container-flude my-2">
        <div id="carouselExampleSlidesOnly" class="carousel slide " style="background-color: #8b5c7e; color:white;"
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item ">
                    <div class="container con my-4">
                        <img src="image/im.jpg" style="margin-left: 40px;" class="rounded-circle my-3 shadow"
    ...
    <div class="container-fluid" style="background-color: #8b5c7e; color:white;">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-3">
                    <div class="card">
                        <img src="image/clothes.jpg" class="d-block w-100" alt="..." height="250px" width="400px">
                    </div>
                </div>
                <div class="col-3">
                    <div class="card">
